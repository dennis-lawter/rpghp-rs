...
** TODO Create creature returns the record or redirect header
    - If redirect header, make the session act the same
** TODO Change the way HP is handled in CreatureView
